...
namespace ImperativeToFunctional
{
    ...
    public class Cities
    {
        ...
        {
            double averagePopulationDensity = Math.Round(cities.Average(c => c.Population / c.Area));
        ...
        {
            string[] longCityNames = cities.Where(c => c.Name.Length > 6).Select(c => c.Name).ToArray();
        ...
        {
            //Using "Descending" to start sorting from youngest city.
